...
var settings = {
  ...
  options: {
    ...
    '--componentsDir': 'Directory templates components',
    '--directivesDir': 'Directory templates directives',
    '--pagesDir': 'List available generators',
    '--pipesDir': 'List available generators',
    '--providersDir': 'List available generators',
    '--templateDir': 'List available generators'
  },
  isProjectTask: true
};
